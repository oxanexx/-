...
<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST">
    <h1>Äîáàâèòü ïîñåòèòåëÿ:</h1><br><br><br>
    Èìÿ: <input type="text" name="name"><br><br>
    Íîìåð òåëåôîíà: <input type="text" name="phone"><br><br>
    Ëþáèìîå áëþäî:<select name="sort_value" id="sortValue">
